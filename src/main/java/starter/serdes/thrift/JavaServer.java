...
import example.thrift.tutorial.Calculator.Iface;
...
public class JavaServer {
	...
	public static void simple(Calculator.Processor<? extends Iface> processor) {
		try {
	...
	public static void secure(Calculator.Processor<? extends Iface> processor) {
		try {
			/*
			...
			params.setKeyStore("src/main/resources/thrift/.keystore", "thrift",
					null, null);

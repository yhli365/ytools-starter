...
import example.thrift.shared.SharedStruct;
import example.thrift.tutorial.Calculator;
import example.thrift.tutorial.InvalidOperation;
import example.thrift.tutorial.Operation;
import example.thrift.tutorial.Work;
...
public class JavaClient {
	public static void main(String[] args) {
		...
		if (!("simple".equalsIgnoreCase(cmd) || "secure".equalsIgnoreCase(cmd))) {
		...
		try {
			...
			if (cmd.contains("simple")) {
				...
				params.setTrustStore("src/main/resources/thrift/.truststore",
						"thrift", "SunX509", "JKS");
				/*
